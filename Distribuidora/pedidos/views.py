...
def procesar_pedido(request):
    ...
    if request.method == 'POST':
        ...
        if user_profile_form.is_valid():
            ...
            carro=Carro(request)     #Recupera el Carro de compras del usuario (carro) y procesa su contenido para crear objetos LineaPedido.
            lineas_pedido=list()       #variable en donde se almacenara los items del carro
            for key, value in carro.carro.items():  #Por cada clave valor que haya en los items del carro
            ...
            precio_total = sum(linea.producto.precio * linea.cantidad for linea in lineas_pedido)
...
def enviar_mail(**kwargs):
    ...
    from_email="sebasfelipe011@gmail.com"
...
def portafolio(request):
    ...
    return  render(request,"pedidos/formulario.html",{'projects':projects, 'link':link})
